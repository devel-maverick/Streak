                        ...
                        <div className="mt-6">
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    window.location.href = import.meta.env.MODE === "development" ? "http://localhost:3000/api/auth/google" : "/api/auth/google";
                                }}
                                className="w-full flex items-center justify-center py-3 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-900 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isGoogleLoading ? (
